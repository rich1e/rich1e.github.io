...
[VS Code - Vim 插件自动切换输入法 - 掘金](https://juejin.cn/post/7104850924975161358)
[VS Code VIM 插件高效使用|OhYee 博客](https://www.ohyee.cc/post/note_vim)
[VSCode Vim 插件 输入法自动切换配置 - 知乎](https://zhuanlan.zhihu.com/p/397637955)
[daipeihust/im-select: 📟 Switch your input method through terminal](https://github.com/daipeihust/im-select)
[(6 封私信 / 82 条消息) 如何临时关闭vscode 的vim插件? - 知乎](https://www.zhihu.com/question/420445026)
[vscode快速切换vim - 掘金](https://juejin.cn/post/6844903842362998791)
[How to close vim mode ? · Issue #1055 · VSCodeVim/Vim](https://github.com/VSCodeVim/Vim/issues/1055)
